/**
 * Auto-save draft for Test Builder: localStorage key, TTL 24h, read/write helpers.
 */

export const DRAFT_STORAGE_KEY = 'ielts-test-builder-draft';
...
export interface DraftPayload {
  info: {
    ...
    audioFiles: { section1: string; section2: string; section3: string; section4: string };
  };
  sections: unknown[];
}
