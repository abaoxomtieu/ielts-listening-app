...
interface LocationsFeaturesProps {
  data: MatchingData;
  onAnswerChange?: (questionId: number, answer: string) => void;
  disabled?: boolean;
}

export const LocationsFeatures: React.FC<LocationsFeaturesProps> = ({
  data,
  onAnswerChange,
  disabled = false
}) => {
  ...
  return (
    <div className="w-full bg-white border border-gray-300 shadow-sm p-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        {/* Right Column - Features Matching */}
        <div className="space-y-4">
          <h3 className="text-sm font-bold text-gray-800 uppercase tracking-wide mb-4">
            Features
          </h3>
                ...
                >
                  <Select.Trigger
                    className={`
                      ...
                      min-h-[44px]
                    `}
                    aria-label={`Select feature for ${question.text}`}
                  >
...
export default LocationsFeatures;
