...
export const EventsInfo: React.FC<EventsInfoProps> = ({
  data,
  onAnswerChange,
  disabled = false
}) => {
  ...
  return (
    <div className="w-full bg-white border border-gray-300 shadow-sm p-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        {/* Right Column - Information Matching */}
        <div className="space-y-4">
          <h3 className="text-sm font-bold text-gray-800 uppercase tracking-wide mb-4">
            Information
          </h3>
                ...
                >
                  <Select.Trigger
                    className={`
                      ...
                      min-h-[44px]
                    `}
                    aria-label={`Select information for ${question.text}`}
                  >
                    <Select.Value placeholder="Select information" />
